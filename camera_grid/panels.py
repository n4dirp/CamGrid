...
class CAMGRID_PT_grid_popup(Panel):
    ...
    def draw(self, context):
        ...
        if cam_body:
            header, body = cam_body.panel("CAMGRID_PT_camera_grid_filter_list", default_closed=True)
            ...
            header, body = cam_body.panel("CAMGRID_PT_camera_grid_ui", default_closed=False)
            ...
            header, body = cam_body.panel("CAMGRID_PT_camera_grid_interaction", default_closed=False)
